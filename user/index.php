...
<body>
    ...
    <main class="container">
        <section id="section-table">
            ...
            <div class="row">
                <form class="col s12" method="POST" action="process.php" id="form-user-search">
                    <div class="row center-align">
                        ...
                        <div class="row center-align">
                            <div class="input-field col s12">
                                ...
                                <a class="waves-effect btn brand" id="btn-user-search-clear">Clear</a>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="row">
                <table id="table-user" class="highlight responsive-table centered">
                    <thead>
                        <th>Username</th>
                        <th>E-mail</th>
                        <th>Role</th>
